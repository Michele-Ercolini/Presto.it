    ...
    <section class="container-fluid marginSection">
        ...
        <div class="row justify-content-center align-items-center my-5">
            ...
            <div style="background-color: #edbf67;" class="col-12 col-lg-5 fade-items" data-aos="fade-left"
                data-aos-offset="300"
                data-aos-easing="ease-in-sine">
                <p style="color:black" class="text-center lh-lg "><strong class=" lh-lg fs-3" style="color:#952932">{{__('ui.titolo2')}}</strong>{{__('ui.articolo2')}}</p>
            </div>
        ...
        <div  class="row justify-content-center align-items-center my-5">
            <div style="background-color: #edbf67;" class="col-12 col-lg-5 fade-items" data-aos="fade-right"
                data-aos-offset="300"
                data-aos-easing="ease-in-sine">
                <p style="color:black" class=" text-center lh-lg "><strong style="color:#952932" class=" lh-lg fs-3">{{__('ui.titolo3')}}</strong>{{__('ui.articolo3')}}</p>
            </div>
            <div class="col-12 col-lg-4">
